...
SECRET_KEY = "django-insecure-=a^j5@ps73u86=*q$@qtv&y8m=h+ujytiappe)h-@+va(q*oxd"
...
ALLOWED_HOSTS=['add-recipe-backend-2.onrender.com']
...
EMAIL_HOST_PASSWORD="ijhnbvoeccqzpvvu"
